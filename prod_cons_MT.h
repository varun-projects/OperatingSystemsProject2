...
File Name         : prod_cons_MT.h  , part of Module prod_cons_MT
...
// ------ Memory orgnanization: Queue structure ------
typedef struct {
...
void math_buff(float buffer_size,float consumer_num ); // custom math function -- distribute data to given consumer threads  
